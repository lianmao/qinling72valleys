...
> 三类周边清单与其余字段同等对待：未核实即在前端标注「待核实」，不得默认推荐；「网红打卡点」主观性强，只写机位与看点，不承诺效果，也不提供进入未开放区域的路线。
...
```json
{
  ...
  "around": {
    ...
    "family_spots": [
      { "name": "大峪水库浅滩戏水区", "note": "夏季戏水，需成人全程看护", "source": "PRD §4.1" },
      { "name": "十里庙林荫步道", "note": "缓坡短程，适合亲子散步", "source": "PRD §4.1" }
    ],
    "photo_spots": [
      { "name": "大峪水库大坝观景平台", "note": "库区水面与群山同框", "source": "PRD §4.1" }
    ]
  }
}
```
